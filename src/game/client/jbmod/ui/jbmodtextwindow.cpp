...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CJBModTextWindow::CJBModTextWindow(IViewPort *pViewPort) : CTextWindow( pViewPort )
{
...
// Purpose: Destructor
//-----------------------------------------------------------------------------
CJBModTextWindow::~CJBModTextWindow()
{
}
...
// Purpose: 
//-----------------------------------------------------------------------------
void CJBModTextWindow::SetVisible(bool state)
{
...
//-----------------------------------------------------------------------------
void CJBModTextWindow::ShowPanel(bool bShow)
{
	if ( bShow )
	{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CJBModTextWindow::OnKeyCodePressed(KeyCode code)
{
...
//-----------------------------------------------------------------------------
void CJBModTextWindow::PaintBackground()
{
}
...
//-----------------------------------------------------------------------------
void CJBModTextWindow::PerformLayout()
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CJBModTextWindow::ApplySchemeSettings( vgui::IScheme *pScheme )
{
	BaseClass::ApplySchemeSettings( pScheme );
	ApplyBackgroundSchemeSettings( this, pScheme );
}

CJBModSpectatorGUI::CJBModSpectatorGUI(IViewPort *pViewPort) : CSpectatorGUI(pViewPort)
{
}


bool CJBModSpectatorGUI::NeedsUpdate( void )
{
...
void CJBModSpectatorGUI::Update()
{
	BaseClass::Update();
