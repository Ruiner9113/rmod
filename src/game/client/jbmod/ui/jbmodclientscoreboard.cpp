...
// Purpose: Konstructor
//-----------------------------------------------------------------------------
CJBModClientScoreBoardDialog::CJBModClientScoreBoardDialog(IViewPort *pViewPort):CClientScoreBoardDialog(pViewPort)
{
...
// Purpose: Destructor
//-----------------------------------------------------------------------------
CJBModClientScoreBoardDialog::~CJBModClientScoreBoardDialog()
{
}
...
//-----------------------------------------------------------------------------
void CJBModClientScoreBoardDialog::PaintBackground()
{
...
//-----------------------------------------------------------------------------
void CJBModClientScoreBoardDialog::PaintBorder()
{
	int x1, x2, y1, y2;
...
//-----------------------------------------------------------------------------
void CJBModClientScoreBoardDialog::ApplySchemeSettings( vgui::IScheme *pScheme )
{
...
//-----------------------------------------------------------------------------
void CJBModClientScoreBoardDialog::InitScoreboardSections()
{
	m_pPlayerList->SetBgColor( Color(0, 0, 0, 0) );
	m_pPlayerList->SetBorder(NULL);
...
//-----------------------------------------------------------------------------
void CJBModClientScoreBoardDialog::UpdateTeamInfo()
{
	if ( g_PR == NULL )
		return;
...
//-----------------------------------------------------------------------------
void CJBModClientScoreBoardDialog::AddHeader()
{
	// add the top header
...
//-----------------------------------------------------------------------------
void CJBModClientScoreBoardDialog::AddSection(int teamType, int teamNumber)
{
...
int CJBModClientScoreBoardDialog::GetSectionFromTeamNumber( int teamNumber )
{
	switch ( teamNumber )
	{
	case TEAM_COMBINE:
...
//-----------------------------------------------------------------------------
bool CJBModClientScoreBoardDialog::GetPlayerScoreInfo(int playerIndex, KeyValues *kv)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CJBModClientScoreBoardDialog::UpdatePlayerInfo()
{
