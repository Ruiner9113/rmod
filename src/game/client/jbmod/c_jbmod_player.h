...
// >> JBMOD_Player
//=============================================================================
class C_JBMod_Player : public C_BaseHLPlayer
{
public:
	DECLARE_CLASS( C_JBMod_Player, C_BaseHLPlayer );
	...
	static C_JBMod_Player* GetLocalJBModPlayer();
...
private:
	...
	CNetworkVar( JBModPlayerState, m_iPlayerState );	

	bool m_fIsWalking = false;
};

inline C_JBMod_Player *ToJBModPlayer( CBaseEntity *pEntity )
{
	if ( !pEntity || !pEntity->IsPlayer() )
		return NULL;

	return dynamic_cast<C_JBMod_Player*>( pEntity );
}


class C_JBModRagdoll : public C_BaseAnimatingOverlay
{
public:
	DECLARE_CLASS( C_JBModRagdoll, C_BaseAnimatingOverlay );
	DECLARE_CLIENTCLASS();
...
private:
	...
	C_JBModRagdoll( const C_JBModRagdoll & ) {}

	void Interp_Copy( C_BaseAnimatingOverlay *pDestinationEntity );
	void CreateJBModRagdoll( void );
