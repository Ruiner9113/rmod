...
class C_TEJBModFireBullets : public C_BaseTempEntity
{
public:
	DECLARE_CLASS( C_TEJBModFireBullets, C_BaseTempEntity );
	DECLARE_CLIENTCLASS();
...
void C_TEJBModFireBullets::CreateEffects( void )
{
...
void C_TEJBModFireBullets::PostDataUpdate( DataUpdateType_t updateType )
{
...
IMPLEMENT_CLIENTCLASS_EVENT( C_TEJBModFireBullets, DT_TEJBModFireBullets, CTEJBModFireBullets );


BEGIN_RECV_TABLE_NOBASE(C_TEJBModFireBullets, DT_TEJBModFireBullets )
