...
#ifndef JBMOD_BOT_MANAGER_H
#define JBMOD_BOT_MANAGER_H
...
//----------------------------------------------------------------------------------------------
class CJBModBotManager : public NextBotManager
{
public:
	CJBModBotManager();
	virtual ~CJBModBotManager();
	...
	CJBModBot* GetAvailableBotFromPool();
