...
//---------------------------------------------------------------------------------------------
CJBModBotNavEntDestroyEntity::CJBModBotNavEntDestroyEntity( const CFuncNavPrerequisite *prereq )
{
	m_prereq = prereq;
}
...
//---------------------------------------------------------------------------------------------
ActionResult< CJBModBot >	CJBModBotNavEntDestroyEntity::OnStart( CJBModBot *me, Action< CJBModBot > *priorAction )
{
	if ( m_prereq == NULL )
	{
	...
	m_wasIgnoringEnemies = me->HasAttribute( CJBModBot::IGNORE_ENEMIES );
...
//---------------------------------------------------------------------------------------------
void CJBModBotNavEntDestroyEntity::DetonateStickiesWhenSet( CJBModBot *me, CWeapon_SLAM *slam ) const
{
...
//---------------------------------------------------------------------------------------------
ActionResult< CJBModBot >	CJBModBotNavEntDestroyEntity::Update( CJBModBot *me, float interval )
{
	if ( m_prereq == NULL )
	{
	...
	{
		me->SetAttribute( CJBModBot::IGNORE_ENEMIES );
	...
	{
		me->ClearAttribute( CJBModBot::IGNORE_ENEMIES );
	}
...
//---------------------------------------------------------------------------------------------
void CJBModBotNavEntDestroyEntity::OnEnd( CJBModBot *me, Action< CJBModBot > *nextAction )
{
	if ( !m_wasIgnoringEnemies )
	{
		me->ClearAttribute( CJBModBot::IGNORE_ENEMIES );
