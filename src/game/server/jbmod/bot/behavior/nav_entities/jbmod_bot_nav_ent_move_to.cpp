...
//---------------------------------------------------------------------------------------------
CJBModBotNavEntMoveTo::CJBModBotNavEntMoveTo( const CFuncNavPrerequisite *prereq )
{
	m_prereq = prereq;
	m_pGoalArea = NULL;
}
...
//---------------------------------------------------------------------------------------------
ActionResult< CJBModBot >	CJBModBotNavEntMoveTo::OnStart( CJBModBot *me, Action< CJBModBot > *priorAction )
{
	if ( m_prereq == NULL )
	{
...
//---------------------------------------------------------------------------------------------
ActionResult< CJBModBot >	CJBModBotNavEntMoveTo::Update( CJBModBot *me, float interval )
{
	if ( m_prereq == NULL )
	{
