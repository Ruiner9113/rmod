...
extern ConVar jbmod_bot_defense_must_defend_time;

ConVar jbmod_bot_debug_seek_and_destroy( "jbmod_bot_debug_seek_and_destroy", "0", FCVAR_CHEAT );
ConVar jbmod_bot_disable_seek_and_destroy( "jbmod_bot_disable_seek_and_destroy", "0", FCVAR_CHEAT );


//---------------------------------------------------------------------------------------------
CJBModBotSeekAndDestroy::CJBModBotSeekAndDestroy( float duration )
{
	if ( duration > 0.0f )
	{
...
//---------------------------------------------------------------------------------------------
ActionResult< CJBModBot >	CJBModBotSeekAndDestroy::OnStart( CJBModBot *me, Action< CJBModBot > *priorAction )
{
	...
	if ( jbmod_bot_disable_seek_and_destroy.GetBool() )
	{
...
//---------------------------------------------------------------------------------------------
ActionResult< CJBModBot >	CJBModBotSeekAndDestroy::Update( CJBModBot *me, float interval )
{
	...
	if ( bShouldAttack )
	{
		...
		{
			return SuspendFor( new CJBModBotAttack, "Going after an enemy" );
		}
	}
	else if ( !me->IsPropHater() )
	{
		bool wantsProp = me->Physcannon_GetHeldProp() == NULL;
		if ( wantsProp && CJBModBotGetProp::IsPossible( me ) )
		{
			return SuspendFor( new CJBModBotGetProp, "Grabbing prop" );
		}
	}
...
//---------------------------------------------------------------------------------------------
ActionResult< CJBModBot > CJBModBotSeekAndDestroy::OnResume( CJBModBot *me, Action< CJBModBot > *interruptingAction )
{
	RecomputeSeekPath( me );
...
//---------------------------------------------------------------------------------------------
EventDesiredResult< CJBModBot > CJBModBotSeekAndDestroy::OnStuck( CJBModBot *me )
{
	RecomputeSeekPath( me );
...
//---------------------------------------------------------------------------------------------
EventDesiredResult< CJBModBot > CJBModBotSeekAndDestroy::OnMoveToSuccess( CJBModBot *me, const Path *path )
{
	RecomputeSeekPath( me );
...
//---------------------------------------------------------------------------------------------
EventDesiredResult< CJBModBot > CJBModBotSeekAndDestroy::OnMoveToFailure( CJBModBot *me, const Path *path, MoveToFailureType reason )
{
	RecomputeSeekPath( me );
...
//---------------------------------------------------------------------------------------------
QueryResultType	CJBModBotSeekAndDestroy::ShouldRetreat( const INextBot *meBot ) const
{
...
//---------------------------------------------------------------------------------------------
QueryResultType CJBModBotSeekAndDestroy::ShouldHurry( const INextBot *me ) const
{
	return ANSWER_UNDEFINED;
}
...
//---------------------------------------------------------------------------------------------
void CJBModBotSeekAndDestroy::RecomputeSeekPath( CJBModBot *me )
{
...
//---------------------------------------------------------------------------------------------
EventDesiredResult< CJBModBot > CJBModBotSeekAndDestroy::OnTerritoryContested( CJBModBot *me, int territoryID )
{
...
//---------------------------------------------------------------------------------------------
EventDesiredResult< CJBModBot > CJBModBotSeekAndDestroy::OnTerritoryCaptured( CJBModBot *me, int territoryID )
{
...
//---------------------------------------------------------------------------------------------
EventDesiredResult< CJBModBot > CJBModBotSeekAndDestroy::OnTerritoryLost( CJBModBot *me, int territoryID )
{
...
//---------------------------------------------------------------------------------------------
EventDesiredResult< CJBModBot > CJBModBotSeekAndDestroy::OnCommandApproach( CJBModBot* me, const Vector& pos, float range )
{
