...
class CWeaponCrossbow : public CBaseJBModCombatWeapon
{
	DECLARE_CLASS( CWeaponCrossbow, CBaseJBModCombatWeapon );
public:
...
void CWeaponCrossbow::FireBolt( void )
{
	...
	CCrossbowBolt *pBolt = CCrossbowBolt::BoltCreate( vecSrc, angAiming, GetJBModWpnData().m_iPlayerDamage, pOwner );
