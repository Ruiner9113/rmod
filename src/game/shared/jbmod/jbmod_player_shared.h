...
//
//=============================================================================//
#ifndef JBMOD_PLAYER_SHARED_H
#define JBMOD_PLAYER_SHARED_H
#pragma once
...
#define CJBMod_Player C_JBMod_Player
#endif
...
public:
	...
	CPlayerAnimState( CJBMod_Player *outer );
