...
LINK_ENTITY_TO_CLASS( basejbmodcombatweapon, CBaseJBModCombatWeapon );

IMPLEMENT_NETWORKCLASS_ALIASED( BaseJBModCombatWeapon , DT_BaseJBModCombatWeapon )

BEGIN_NETWORK_TABLE( CBaseJBModCombatWeapon , DT_BaseJBModCombatWeapon )
...
// Save/Restore
//---------------------------------------------------------
BEGIN_DATADESC( CBaseJBModCombatWeapon )
...
BEGIN_PREDICTION_DATA( CBaseJBModCombatWeapon )
...
CBaseJBModCombatWeapon::CBaseJBModCombatWeapon( void )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CBaseJBModCombatWeapon::ItemHolsterFrame( void )
{
...
//-----------------------------------------------------------------------------
bool CBaseJBModCombatWeapon::Lower( void )
{
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CBaseJBModCombatWeapon::Ready( void )
{
	//Don't bother if we don't have the animation
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CBaseJBModCombatWeapon::Deploy( void )
{
	// If we should be lowered, deploy in the lowered position
	// We have to ask the player if the last time it checked, the weapon was lowered
	if ( GetOwner() && GetOwner()->IsPlayer() )
	{
		CJBMod_Player *pPlayer = assert_cast<CJBMod_Player*>( GetOwner() );
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CBaseJBModCombatWeapon::Holster( CBaseCombatWeapon *pSwitchingTo )
{
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CBaseJBModCombatWeapon::WeaponShouldBeLowered( void )
{
...
//-----------------------------------------------------------------------------
void CBaseJBModCombatWeapon::WeaponIdle( void )
{
...
// Output : float
//-----------------------------------------------------------------------------
float CBaseJBModCombatWeapon::CalcViewmodelBob( void )
{
...
//			viewmodelindex - 
//-----------------------------------------------------------------------------
void CBaseJBModCombatWeapon::AddViewmodelBob( CBaseViewModel *viewmodel, Vector &origin, QAngle &angles )
{
...
//-----------------------------------------------------------------------------
Vector CBaseJBModCombatWeapon::GetBulletSpread( WeaponProficiency_t proficiency )
{
	return BaseClass::GetBulletSpread( proficiency );
}

//-----------------------------------------------------------------------------
float CBaseJBModCombatWeapon::GetSpreadBias( WeaponProficiency_t proficiency )
{
	return BaseClass::GetSpreadBias( proficiency );
}
//-----------------------------------------------------------------------------

const WeaponProficiencyInfo_t *CBaseJBModCombatWeapon::GetProficiencyValues()
{
	return NULL;
}
...
//-----------------------------------------------------------------------------
const WeaponProficiencyInfo_t *CBaseJBModCombatWeapon::GetDefaultProficiencyValues()
{
